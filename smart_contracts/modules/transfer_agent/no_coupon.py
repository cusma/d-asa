...
class NoCouponTransferAgentMixin(TransferAgentCommonMixin):
    """Transfers ownership for products without coupon gating."""
    ...
    def asset_transfer(
        ...
        *,
        ...
        accrued_interest = self.core_prepare_transfer_no_coupon(
